...
{{--                        <form method="POST" action="{{route('postselectprofile')}}">--}}
{{--                            @csrf--}}
...
{{--                                </ul>--}}
{{--                                <div class="plan_btn">--}}
{{--                                    <a href="{{route("postselectprofile",['role_id' => 2])}}">Signup Freelancer Profile</a>--}}
{{--                                </div>--}}
...
{{--                                </ul>--}}
{{--                                <div class="plan_btn">--}}
{{--                                    <a href="{{route("postselectprofile",['role_id' => 3])}}">Signup Company Profile</a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </form>--}}
