...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Privacy Policy List</h6>
        </div>
        <div class="card-body">
                ...
                <table id="datatable" class="table table-striped thead-primary w-100">
                    ...
                    @foreach($show as $items)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('backend.edit-privacypolicy',$items->id)}}" data-toggle="tooltip" data-placement="top" title="edit" class="fas fa-pencil-alt ms-text-primary"></a>
                            </td>
                    @endforeach
                    </tbody>
                </table>
