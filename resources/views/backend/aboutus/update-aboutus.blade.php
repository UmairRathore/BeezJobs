...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="{{route('backend.aboutus-list')}}" class="btn btn-primary ms-text-primary">About US List</a>
        </div>
        <div class="card-body">
            ...
            <form  method="POST" action="{{ route ('backend.update-aboutus', $show->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
