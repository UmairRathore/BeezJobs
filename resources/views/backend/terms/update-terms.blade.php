...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Update Terms</h6>
            <a href="{{route('backend.terms-list')}}" class="btn btn-primary ms-text-primary">Terms List</a>
        </div>
        <div class="card-body">
            ...
            <form  method="POST" action="{{ route ('backend.update-terms', $show->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
