                ...
                <table id="datatable" class="table table-striped thead-primary w-100">
                    ...
                    @foreach($show as $items)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('backend.edit-terms',$items->id)}}" data-toggle="tooltip" data-placement="top" title="edit" class="fas fa-pencil-alt ms-text-primary"></a>
                            </td>
                    @endforeach
                    </tbody>
                </table>
